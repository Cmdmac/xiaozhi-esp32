...
class decode_results {
 public:
  ...
  ir_atomic_uint16_t *rawbuf;    // Raw intervals in .5 us ticks
...
class IRrecv {
 ...
 private:
  ...
  bool matchAtLeast(const uint32_t measured, const uint32_t desired,
                    const uint8_t tolerance = kUseDefTol,
                    const uint16_t delta = 0);
  uint16_t _matchGeneric(ir_atomic_uint16_t *data_ptr,
  ...
  match_result_t matchData(ir_atomic_uint16_t *data_ptr, const uint16_t nbits,
  ...
  uint16_t matchBytes(ir_atomic_uint16_t *data_ptr, uint8_t *result_ptr,
                      ...
                      const bool MSBfirst = true,
                      const bool expectlastspace = true);
  uint16_t matchGeneric(ir_atomic_uint16_t *data_ptr,
                        uint64_t *result_ptr,
  ...
  uint16_t matchGeneric(ir_atomic_uint16_t *data_ptr,
                        ...
                        const int16_t excess = kMarkExcess,
                        const bool MSBfirst = true);
  uint16_t matchGenericConstBitTime(ir_atomic_uint16_t *data_ptr,
                                    uint64_t *result_ptr,
                                    const uint16_t remaining,
                                    ...
                                    const int16_t excess = kMarkExcess,
                                    const bool MSBfirst = true);
  uint16_t matchManchesterData(ir_atomic_const_uint16_t *data_ptr,
                               uint64_t *result_ptr,
                               const uint16_t remaining,
                               const uint16_t nbits,
  ...
  uint16_t matchManchester(ir_atomic_const_uint16_t *data_ptr,
                           uint64_t *result_ptr,
                           const uint16_t remaining,
                           const uint16_t nbits,
                           const uint16_t hdrmark,
